...
$(function () {
    ...
    var url = 'https://web.archive.org/web/20120810212605/http://www.smore.com/clippy-js';
    // twitter counter
    $.ajax('https://web.archive.org/web/20120810212605/http://cdn.api.twitter.com/1/urls/count.json', {data:{url:url},
        dataType:'jsonp',
    ...
    // facebook counter
    $.ajax('https://web.archive.org/web/20120810212605/http://graph.facebook.com/' + url,{
        dataType:'jsonp',
        success:function (data) {
...
/*
     FILE ARCHIVED ON 21:26:05 Aug 10, 2012 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 09:42:40 Apr 06, 2024.
...
playback timings (ms):
  ...
  cdx.remote: 0.065
  esindex: 0.01
  LoadShardBlock: 108.679 (3)
  PetaboxLoader3.datanode: 45.83 (4)
  PetaboxLoader3.resolve: 91.474 (2)
  load_resource: 72.601
*/