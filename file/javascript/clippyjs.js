...
if (!self.__WB_pmw) {
    ...
    }, clippy.BASE_PATH = "https://web.archive.org/web/20120810212605/http://clippy.js.s3.amazonaws.com/Agents/", clippy.load = function(a, b, c) {
    ...
    $(function() {
        ...
        // twitter counter
        $.ajax('https://web.archive.org/web/20120810212605/http://cdn.api.twitter.com/1/urls/count.json', {
            data: {
                url: url
            },
            dataType: 'jsonp',
